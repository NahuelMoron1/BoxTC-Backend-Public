...
const getGameOfTheDay = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const game = yield associations_1.GuessDrivers.findOne({
            where: {
                date: today,
            },
            include: [
                ...
                {
                    model: associations_1.GuessDrivers_Teams,
            ...
            order: [[associations_1.GuessDrivers_Teams, 'ordered', 'ASC']],
        });
        if (!game) {
        ...
        const gameTeams = game.get("GuessDrivers_Teams");
        // Transformar los datos para que tengan la estructura correcta
        const transformedTeams = gameTeams.map(team => {
            var _a, _b, _c, _d;
            return {
                id: team.id,
                Team: {
                    id: ((_a = team.team) === null || _a === void 0 ? void 0 : _a.id) || '',
                    name: ((_b = team.team) === null || _b === void 0 ? void 0 : _b.name) || '',
                    common_name: ((_c = team.team) === null || _c === void 0 ? void 0 : _c.common_name) || '',
                    logo: ((_d = team.team) === null || _d === void 0 ? void 0 : _d.logo) || ''
                },
                ordered: team.ordered,
        ...
        return res.json({
            ...
            Teams: [firstTeam], // Solo enviamos el primer equipo inicialmente
...
const getNextTeam = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const teams = game.get("GuessDrivers_Teams");
